...
class TMALoadTiledOpPattern : public OpRewritePattern<ttn::TMALoadTiledOp> {
public:
  using OpRewritePattern<ttn::TMALoadTiledOp>::OpRewritePattern;
...
class TMAStoreTiledOpPattern : public OpRewritePattern<ttn::TMAStoreTiledOp> {
public:
  using OpRewritePattern<ttn::TMAStoreTiledOp>::OpRewritePattern;
...
class OffsetOfSts64OpPattern : public OpRewritePattern<ttn::OffsetOfSts64Op> {
public:
  using OpRewritePattern<ttn::OffsetOfSts64Op>::OpRewritePattern;
...
class OffsetOfStmatrixV4OpPattern
    : public OpRewritePattern<ttn::OffsetOfStmatrixV4Op> {
public:
  using OpRewritePattern<ttn::OffsetOfStmatrixV4Op>::OpRewritePattern;
...
#undef POPULATE_NVGPU_OP
    ...
    patterns.add<FenceAsyncSharedOpPattern, StoreMatrixOpPattern,
                 ...
                 TMAStoreTiledOpPattern, WGMMAOpPattern,
                 WGMMAWaitGroupOpPattern, OffsetOfSts64OpPattern>(context);
